...
У рамки файлу .env було додано git-token, щоб надати можливість автоматичного пушу виведеного файлу до Git.
...
```
0 0 * * * docker exec nginx-log-analyzer /app/script.sh /app/logs/nginx.log all
```
